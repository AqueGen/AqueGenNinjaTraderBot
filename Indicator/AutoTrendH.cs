...
//		if (  (DrawObjects["UpTrendRay"].Locked) || (DrawObjects["DowntrendTrendRay"].Locked) ) 
	...
	//PROCESS UPTREND LINE IF CURRENT
			...
			{	//Print("Now UP Trend Line");
				
				IsUpTrend = true;
				Print("IsUpTrend true");
				System.IO.File.WriteAllText("testNinja.txt", "true");
	...
	//DETECT AND PROCESS DOWNTREND LINE	IF CURRENT	
			...
			{	//Print("Now DOWN Trend Line");
				...
				IsUpTrend = false;
				Print("IsUpTrend false");
				System.IO.File.WriteAllText("testNinja.txt", "false");
